...
public class bossArmour implements Armour {    //Normal armour that usually gives common rarity drops
    ...
    public Rarity generateRarity() {
        ...
        int rarityNumber = random.nextInt(10);
        if (rarityNumber <= 3) {   //less likely to be common
